...
/**
 * Entity mapped to table "YMDC__TB".
 */
public class YMDC_TB
{
	...
	public YMDC_TB(String YMBH)
	{
		this.YMBH = YMBH;
	}

	public YMDC_TB(String YDH, String YMBH, String SZDM, double XIONGJING,
			Double PJMSG, String LMZL, String LMXL, String SSLC, String BEIZHU)
	{
		this.YDH = YDH;
		this.YMBH = YMBH;
		this.SZDM = SZDM;
	 ...
	 * database.
	 */
	public void setLMXL(String LMXL)
	{
		this.LMXL = LMXL;
	}
