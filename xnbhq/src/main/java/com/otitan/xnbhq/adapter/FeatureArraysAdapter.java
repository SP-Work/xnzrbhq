 ...
 * 小班查询Adapter
 */
public class FeatureArraysAdapter extends BaseAdapter {
    ...
    public FeatureArraysAdapter(long[] list,Context context,MyLayer myLayer) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GeodatabaseFeature feature = (GeodatabaseFeature) myLayer.getLayer().getFeature(list[position]);
