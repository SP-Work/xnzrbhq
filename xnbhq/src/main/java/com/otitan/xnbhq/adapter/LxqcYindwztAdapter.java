...
import com.otitan.xnbhq.dialog.SlzylxqcYindwztDialog;
...
/**
 * 连续清查 引点位置图拍照 adapter
 */
public class LxqcYindwztAdapter extends BaseAdapter {

	private LayoutInflater inflater = null;
	private List<HashMap<String, String>> list = new ArrayList<>();
	private Context context;

	public LxqcYindwztAdapter(Context context, List<HashMap<String, String>> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.tv5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				SlzylxqcYindwztDialog.refreshdata();
			}
		});
		return convertView;
	}
